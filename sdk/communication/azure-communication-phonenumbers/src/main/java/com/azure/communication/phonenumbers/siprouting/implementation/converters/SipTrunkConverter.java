...
public final class SipTrunkConverter {
     ...
     */
    public static List<SipTrunk> convert(Map<String, com.azure.communication.phonenumbers.siprouting.implementation.models.SipTrunk> obj) {
        if (obj == null) {
            return null;
        }
     ...
     */
    public static SipTrunk convert(com.azure.communication.phonenumbers.siprouting.implementation.models.SipTrunk obj,
                                   String fqdn) {
        if (obj == null) {
            return null;
        }
     ...
     */
    public static Map<String, com.azure.communication.phonenumbers.siprouting.implementation.models.SipTrunk> convert(List<SipTrunk> obj) {
        if (obj == null) {
            return null;
        }
     ...
     */
    public static com.azure.communication.phonenumbers.siprouting.implementation.models.SipTrunk convert(SipTrunk obj) {
        if (obj == null) {
            return null;
        }
